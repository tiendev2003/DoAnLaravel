            ...
            <div class="row gx-4 ">
                <div class=" col-xl-4 rounded-9">
                    <div class="card shadow ">
                        <form action="{{ route('shipper.profile.updateImg', ['id' => $user->id]) }}" method="POST"
                ...
                <div class=" col-xl-4 ">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('shipper.profile.update', ['id' => $user->id]) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" value="{{ $user->sdt }}"
                                            name="sdt" id="test">
                                    </div>
                                </div>
                                <div class="row">
